...
class DevsFirstPageControllerTest {

    private DevsFirstPageController controller;
    ...
    void start(Stage primaryStage)throws Exception{
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Devs_First_Page.fxml"));
        ...
        primaryStage.setTitle("Cloud-Based Gaming Library - DevsFirstPage");
    ...
    @Test
    @DisplayName("Testing the -Go to DevPage - button functionality")
    void test1(FxRobot robot) {
        robot.clickOn("#goDevPage");
    }
